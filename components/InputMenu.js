	...
	render() {
		return (
			<div id="mky-menu-bubble" className="mky-menu-bubble" style={{display : this.props.visible ? "block" : "none"}}>
				...
				<div className="mky-menu-bubble-item" onClick={this.props.handleAttach}><i id="mky-menu-attach-file" className="icon mky-icon-doc-regular" style={this.props.colorButton}></i><div>File</div></div>
