...
class BubbleImageLink extends Component {
	constructor(props) {
		super(props);
	...
	render() {
		return (
			<div className='mky-content-image-link'>
				{ this.props.message.data
					? ( <div className={'mky-content-image-data ' +this.state.imageHeightAuto + ' '+this.state.imageOrientation}>
							<a href={this.props.message.link} target="_blank"><img src={this.props.message.data}></img></a>
						</div>
					)
...
export default BubbleImageLink;
